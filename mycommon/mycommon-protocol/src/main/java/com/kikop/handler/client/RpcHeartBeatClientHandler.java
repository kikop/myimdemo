...
//public class RpcHeartBeatClientHandler extends ChannelInboundHandlerAdapter {
//
//    // 心跳的时间间隔，单位为s
//    private static final int HEARTBEAT_INTERVAL = 100;
//
//    // 在 Handler被加入到Pipeline时，开始发送心跳
//    @Override
//    public void handlerAdded(ChannelHandlerContext ctx)
//            throws Exception {
//        ClientSession session = ClientSession.getSession(ctx);
//        LoginUserVo loginUserVo = session.getLoginUserVo();
//
