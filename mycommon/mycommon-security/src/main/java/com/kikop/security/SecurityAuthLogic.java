package com.kikop.security;

import com.kikop.annotation.Logical;
...
import com.kikop.exception.auth.NotLoginException;
import com.kikop.exception.auth.NotPermissionException;
import com.kikop.exception.auth.NotRoleException;
 ...
 * @author ruoyi
 */
public class SecurityAuthLogic {
    ...
    public RedisTokenService tokenService = SpringUtils.getBean(RedisTokenService.class);
